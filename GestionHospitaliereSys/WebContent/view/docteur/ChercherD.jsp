...
<c:when test="${sessionScope.login != null}">
 <ul class="sidebar">
  <li class="sidebar-brand"><a href="./view/accueil/accueil.jsp">Gestion Hospitaliere</a></li>
      <li><a href="AjoutD.jsp"><i class="fa fa-plus-square" aria-hidden="true"></i><span class="ml-1">Ajouter</span></a></li>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Chercher un docteur</h4>
                  <p class="card-category">Les informations du docteur</p>
                </div>
                <div class="card-body">
 <form method='POST' action='../../ChercherDoc'>
