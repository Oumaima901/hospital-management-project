...
<ul class="sidebar">
  <li class="sidebar-brand"><a href="./view/accueil/accueil.jsp">Gestion Hospitaliere</a></li>
   <li> <a href="../../DocteurPat" ><i class="fa fa-plus-square" aria-hidden="true"></i> <span class="ml-1">Ajouter</span></a></li>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Chercher un patient</h4>
                  <p class="card-category">Les informations du patient</p>
                </div>
                <div class="card-body">
 <form method='POST' action='../../ChercherPat'>
 ...
 <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id='txtnompat' name='txtnompat' type='text' required='required'class="form-control">
                        </div>
                      </div>
                    </div>
